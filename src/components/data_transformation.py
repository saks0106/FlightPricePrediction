...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''
        This function is responsible for data transformation ie create pkl file for data transformation
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            preprocessing_obj=self.get_data_transformer_object() #all column transformation
