...
"""in classes we use init, using dataclass can allow to directly use class variables.          dataclass is basically used for creating class variables..."""
...
class DataIngestion:
    def __init__(self):
        self.ingestion_config=DataIngestionConfig() #3paths from above will be saved
